      ...
      <el-row :gutter="20">
        <el-col :span="6">
          <div class="out-border">
            ...
            <div class="color-main address-content">
              <a href="http://water-melon.top/" target="_blank">个人博客</a>
            </div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="out-border">
            ...
            <div class="color-main address-content">
              <a href="http://water-melon.top/categories/go商城" target="_blank"
                >mall-go教程</a
              >
            </div>
          </div>
        ...
        <el-col :span="6">
          <div class="out-border">
            ...
            <div class="color-main address-content">
              <a href="https://github.com/ChangSZ/mall-go" target="_blank"
                >mall-go项目</a
              >
            </div>
          </div>
    ...
    <el-card class="mine-layout">
      <div style="text-align: center">
        <img
          width="150px"
          height="150px"
          src="https://water-melon.top/static/assets/img/nice.png"
        />
      </div>
    </el-card>
